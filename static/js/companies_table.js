    ...
    columns: [
                ...
                },
                {
                    ...
                    formatter: (cell, row) => {
                        ...
                        let action_html = `<button type="button" class="view-btn" data-id=${company_id}>View</button>`;
                        if(role === "admin") {
                            action_html += `<button data-csrf-token=${csrf_token} type="button" class="delete-btn" data-id=${company_id}>Delete</button>`
                        }
